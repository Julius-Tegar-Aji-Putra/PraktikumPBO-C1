...
/**
 * File : GUIp2.java
 * Deskripsi : Main program untuk GUI Proyek 2
 ...
 * @author Julius Tegar
 */
public class GUIp2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIp2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
